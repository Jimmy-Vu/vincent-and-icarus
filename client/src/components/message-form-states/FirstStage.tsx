...
export default function FirstStage(props: messageFormStageProps): React.ReactElement {
  const { onNext, onBack, onQuestionAnswer } = props;
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <section className="h-full pt-5 flex flex-col">
        ...
        <div className="mb-3">
          <input onClick={() => { onQuestionAnswer?.(-1) }} data-score={-1} type="radio" name="mood-q" id="unmotivated" />
          <label className="ml-3" htmlFor="unmotivated">I&apos;m feeling a bit down and unmotivated </label>
        </div>
        <div className="mb-3">
          <input data-score={0} type="radio" name="mood-q" id="good" />
          <label className="ml-3" htmlFor="good">I&apos;m feeling okay about things</label>
        </div>
        <div className="mb-3">
          <input data-score={1} type="radio" name="mood-q" id="confident" />
      ...
      <section className="h-full pt-5 flex flex-col">
        ...
        <div className="mb-3">
          <input data-score={1} type="radio" name="accomplishments-q" id="proud" />
          <label className="ml-3" htmlFor="proud">I&apos;m feeling pretty proud of what I&apos;ve done</label>
        </div>
        <div className="mb-3">
          <input data-score={0} type="radio" name="accomplishments-q" id="uncertain" />
          <label className="ml-3" htmlFor="uncertain">I&apos;m feeling a bit uncertain about my achievements</label>
        </div>
        <div className="mb-3">
          <input data-score={-1} type="radio" name="accomplishments-q" id="unaccomplished" />
